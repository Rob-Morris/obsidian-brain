...
- **Generated output lives under `_Assets/Generated/Printables/`.** The normal output is `_Assets/Generated/Printables/{stem}.pdf`. If one printable workflow produces multiple linked files, add `hub-slug` to the owning artefact if missing and use `_Assets/Generated/Printables/{OwnerType}~{hub-slug}/`.
