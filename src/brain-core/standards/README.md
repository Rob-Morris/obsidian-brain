...
Operational standards for working in a Brain vault. These documents define the
...
- [User preferences](user-preferences.md) — how to interpret user-specific preference and gotcha files
- [Extending the vault](extending/README.md) — add types, memories, and principles
