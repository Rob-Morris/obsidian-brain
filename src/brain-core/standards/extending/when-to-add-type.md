...
- **Worth the overhead** — each type needs a taxonomy file, and types with distinct routing conditions usually need a router trigger (colours are auto-generated). If the content is a one-off, a subfolder or tag within an existing type may be simpler
