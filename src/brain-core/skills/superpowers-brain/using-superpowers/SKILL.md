...
- "Let's build X" → superpowers-brain:brainstorming first, then implementation skills.
- "Fix this bug" → superpowers-brain:systematic-debugging first, then domain skills.
