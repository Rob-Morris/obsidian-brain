...
description: >
  ...
  Use for creative work or heavier shaping when the approach is unclear.
---
...
6. **Write design doc** — save the design (see "After the Design → Documentation" below for location rules) and commit
