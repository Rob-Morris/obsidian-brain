...
Use this file as the bootstrap entry point only. The full session payload lives in `session.start` JSON or the generated markdown mirror at `.brain/local/session.md`.
