...
| `_lifecycle/` | Internal lifecycle/orchestration package: retrieval document-part types, shared retrieval-state errors, and combined lexical+semantic refresh workflows above `_search` and `_semantic` | (library only) |
