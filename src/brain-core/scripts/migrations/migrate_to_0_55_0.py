...
def migrate(vault_root: str) -> dict[str, object]:
    """Replace legacy shared allow-lists or fail before changing the config."""
    ...
    # The pure projector validates the complete input before returning output.
    # Nothing is written when any profile or tool grant is unknown/malformed.
