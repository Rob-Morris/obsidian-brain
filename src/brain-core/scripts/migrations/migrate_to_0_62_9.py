#!/usr/bin/env python3
"""Rename the v0.62.8 document-mutation profile grants."""
...
from _command_interface.profile_migration import migrate_current_document_command_names
...
def migrate(vault_root: str) -> dict[str, object]:
    """Apply the one-to-one document-command rename without widening grants."""
    ...
    projected = migrate_current_document_command_names(
        profiles,
