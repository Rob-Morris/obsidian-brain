...
from _bootstrap.mcp_state import read_toml_server_config, write_toml_config
...
def test_rewrites_recorded_user_scope_claude_and_codex_configs(tmp_path, monkeypatch):
    ...
    write_toml_config(legacy_codex, codex_path)
    ...
    codex = read_toml_server_config(codex_path)
