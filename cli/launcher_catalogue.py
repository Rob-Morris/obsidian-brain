    ...
    tuple(
        sorted(
            (
                ...
                _mutation("brain.backfill", "vault_registry:backfill", "brain", "backfill"),
                _mutation("brain.clear-default", "vault_registry:clear_default", "brain", "clear-default"),
                _read("brain.doctor", "cli:doctor", "brain", "doctor"),
                _read("brain.get-default", "vault_registry:get_default", "brain", "get-default"),
                _mutation("brain.install", "cli:install", "brain", "install"),
                _read("brain.list", "vault_registry:list", "brain", "list"),
                _mutation("brain.prune", "vault_registry:prune", "brain", "prune"),
                _mutation("brain.register", "vault_registry:register", "brain", "register"),
                _read("brain.resolve", "vault_registry:resolve", "brain", "resolve"),
                _mutation("brain.set-default", "vault_registry:set_default", "brain", "set-default"),
                _mutation("brain.uninstall", "cli:uninstall", "brain", "uninstall"),
                _mutation("brain.unregister", "vault_registry:unregister", "brain", "unregister"),
                _mutation("brain.upgrade", "cli:upgrade", "brain", "upgrade"),
                _read("brain.version", "cli:version", "brain", "version"),
                ...
                LauncherEntry("operator.generate-key", 1, "config:generate_operator_key", ("brain", "operator", "generate-key"), "operator", "none", "safe"),
                _mutation("runtime.repair", "repair:runtime", "brain", "runtime", "repair"),
                _read("runtime.resolve", "resolve_brain:resolve", "brain", "runtime", "resolve"),
                _read("runtime.resolve-runnable", "resolve_brain:resolve_runnable", "brain", "runtime", "resolve-runnable"),
            ),
