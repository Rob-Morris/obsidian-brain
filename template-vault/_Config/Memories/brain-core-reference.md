...
New artefact types, skills, styles, and memories can be added without modifying brain-core itself. Run `brain runtime refresh-router --request-json '{}' --json` after changes to regenerate the compiled router.
