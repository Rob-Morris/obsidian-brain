...
- After conversation worth preserving → [[_Config/Taxonomy/Temporal/transcripts]]
- After making a significant decision → [[_Config/Taxonomy/Temporal/decision-logs]]
- When encountering missing context or conflicting info → [[_Config/Taxonomy/Temporal/friction-logs]]
- After shaping each artefact through Q&A → [[_Config/Taxonomy/Temporal/shaping-transcripts]]
