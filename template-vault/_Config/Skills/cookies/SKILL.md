...
Create the cookie artefact using `artefact.create(type="cookies", title=..., content={"source": "inline", "content": ...})`. Do not move on without logging. A cookie that isn't logged didn't happen.
