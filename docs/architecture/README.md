...
How and why Obsidian Brain is structured this way. This layer covers system shape, boundaries, security, and architectural rationale.

- [Architecture Overview](overview.md) — components, data flow, and boundaries
