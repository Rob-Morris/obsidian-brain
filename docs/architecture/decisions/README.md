...
| DD-061 | Typed selected-Brain command application boundary | Implemented (v0.54.1; extended v0.54.2–v0.54.33) | [dd-061](dd-061-typed-command-application-boundary.md) |
