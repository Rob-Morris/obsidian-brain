...
- **Build/search split** — `build_index.py` builds the index, and `search_index.py` queries it in lexical, semantic, or hybrid mode without changing the underlying retrieval contract.
