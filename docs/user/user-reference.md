...
This page is the stable user-facing reference for Brain Core 0.68.7 and CLI 3.3.1. Exact command schemas, examples and availability come from the installed Brain rather than a duplicated hand-maintained inventory.
