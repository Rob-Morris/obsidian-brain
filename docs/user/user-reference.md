...
This page is the stable user-facing reference for Brain Core 0.70.5 and CLI 4.0.4. Exact command schemas, examples and availability come from the installed Brain rather than a duplicated hand-maintained inventory.
