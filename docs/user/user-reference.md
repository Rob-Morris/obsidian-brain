...
This page is the stable user-facing reference for Brain Core 0.59.1 and CLI 2.1.0. Exact command schemas, examples and availability come from the installed Brain rather than a duplicated hand-maintained inventory.
