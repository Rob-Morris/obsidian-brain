...
This page is the stable user-facing reference for Brain Core 0.70.0 and CLI 4.0.0. Exact command schemas, examples and availability come from the installed Brain rather than a duplicated hand-maintained inventory.
