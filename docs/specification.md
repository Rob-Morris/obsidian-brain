...
- **`_Config/`** — instance configuration. Router, taxonomy, style, colour assignments, templates, skills, memories, user preferences. Specific to this vault installation.
...
- `docs/canaries/post-propagation.md` — post-propagation canary: vault log, daily note, master design doc
